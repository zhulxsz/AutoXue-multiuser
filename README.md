...
因为原作者没有更新，因此拿来作为研究学习之用，格遵守开源许可协议。严禁用于商业用途，禁止使用进行任何盈利活动。对一切非法使用所产生的后果，本人概不负责。
# 修改说明2020年9月6日
1.增加了多用户支持，必须提前登录用一次，否则app提示操作会导致程序崩溃，需要修改在main函数里修改用户名列表
2.适配最新版本的学习强国APP
3.删除了每周答题和专项答题，这块不是高频应用，且容易出问题，所以暂时屏蔽
4.目前测试还是有不少问题，欢迎提出修改意见，共同维护
## 免责申明
